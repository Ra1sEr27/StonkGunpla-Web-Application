...
<body id="mainbackground">
    ...
    <div class="container">
		<form action="" method="POST" class="login-email">
			...
			<div class="input-group">
				<button style = "margin-top: 70px; margin-left:70px;" name="submit" class="btn">Login</button>
			</div>
			<p class="login-register-text">Don't have an account? Well, Not too late to do the right thing.</p>
		</form>
	</div>
</body>