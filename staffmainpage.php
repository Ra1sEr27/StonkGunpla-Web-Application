    ...
    <div id= "mainpagebody">
        ...
        <div class="mySlides fade">
            <form action="staffproduct.php" method="POST">
                ...
                <a href="staffproduct.php?productname='HG Wing Gundam'" name="productname"><img src="Images/HG Wing Gundam.jpg" width="100%"></a>
        ...
        <div class="mySlides fade">
            ...
            <a href="staffproduct.php?productname='HG Gundam Deathscyth'" name="productname"><img src="Images/HG Gundam Deathscyth.jpg" width="100%"></a>
        <!-- <div class="text">HG Gundam Deathscythe</div> -->
        </div>

        <div class="mySlides fade">
            <div class="numbertext">3 / 3</div>
            <a href="staffproduct.php?productname='HG Gundam HeavyArms'" name="productname"><img src="Images/HG Gundam HeavyArms.jpg" width="100%"></a>
