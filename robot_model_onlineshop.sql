...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2021 at 04:02 PM
...
INSERT INTO `customerorder` (`OrderID`, `CustomerID`, `PurchaseDate`, `TotalAmount`) VALUES
(4, 2, '2021-11-24', 1283),
(5, 2, '2021-11-24', 4214);
...
INSERT INTO `incart` (`CustomerID`, `ProductID`) VALUES
(1, 2),
(1, 4),
(2, 7),
(2, 8);
...
CREATE TABLE `inorder` (
  `inOrderID` bigint(10) NOT NULL,
  `orderID` bigint(10) NOT NULL,
  `productID` bigint(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `inorder`
--

INSERT INTO `inorder` (`inOrderID`, `orderID`, `productID`) VALUES
(1, 4, 2),
(2, 4, 3),
(3, 5, 7),
(4, 5, 8);
...
INSERT INTO `inwishlist` (`InWishlistID`, `WishlistID`, `ProductID`) VALUES
(1, 1, 6),
(2, 1, 9),
(5, 2, 3),
(6, 2, 8);
...
--
-- Indexes for table `inorder`
--
ALTER TABLE `inorder`
  ADD PRIMARY KEY (`inOrderID`),
  ADD KEY `inOrder_ibfk_1` (`productID`),
  ADD KEY `inOrder_ibfk_2` (`orderID`);

--
-- Indexes for table `inwishlist`
--
ALTER TABLE `inwishlist`
  ADD PRIMARY KEY (`InWishlistID`),
...
--
ALTER TABLE `customerorder`
  MODIFY `OrderID` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `inorder`
--
ALTER TABLE `inorder`
  MODIFY `inOrderID` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `inwishlist`
--
ALTER TABLE `inwishlist`
  MODIFY `InWishlistID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `incart`
  ADD CONSTRAINT `incart_ibfk_1` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`CustomerID`),
  ADD CONSTRAINT `incart_ibfk_2` FOREIGN KEY (`ProductID`) REFERENCES `product` (`ProductID`);

--
-- Constraints for table `inorder`
--
ALTER TABLE `inorder`
  ADD CONSTRAINT `inOrder_ibfk_1` FOREIGN KEY (`productID`) REFERENCES `product` (`ProductID`),
  ADD CONSTRAINT `inOrder_ibfk_2` FOREIGN KEY (`orderID`) REFERENCES `customerorder` (`OrderID`);
